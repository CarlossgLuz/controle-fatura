...
export async function loadMonthlyDashboardSource(referenceDate: Date): Promise<MonthlySourceData> {
  ...
  devInfo('[dashboard] loadMonthlyDashboardSource:start', {
  ...
  devInfo('[dashboard] loadMonthlyDashboardSource:ok', {
